...
#define BOOST_TEST_MODULE sphere_element_area_edgecases
...
BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_0) {
	...
	sphereAreaWorker(s, unitHexahedron(), delta);
}

BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_1) {
...
BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_2) {
...
BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_3) {
...
BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_4) {
...
BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_5) {
...
BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_6) {
...
BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_7) {
...
BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_8) {
	...
	sphereAreaWorker(s, unitHexahedron(0.5), delta);
}

BOOST_AUTO_TEST_CASE(sphere_element_area_edgecase_9) {
